...
![Screenshot showing the Automap UI](https://user-images.githubusercontent.com/6021906/140861523-aee8e582-1f14-48ec-8ee1-cdef3f62932c.png "Screenshot showing the automap UI")
...
<table>
  <thead>
    <tr>
      <th style={{ width: "200px" }}>Entity type</th>
...
### Timewarp: go back in time [#timewarp]
...
### Legend: Understand and control the information on the map [#legend]

The map **Legend** displays the meaning of the icons and line styles that represent various entities and relationships on the map.  Additionally, the legend displays the meaning of health status colors and indication of when anomalies are detected, along with associated controls to de-emphasize certain entities on the map by unchecking those options. For example, you can hide the healthy service to focus only on those alerting as you browse the timeline:

![Screenshot showing where to uncheck options](https://user-images.githubusercontent.com/6021906/140861301-ab66afcb-26df-4920-8f48-d8b95a049ffa.png "Screenshot showing where to uncheck options")
